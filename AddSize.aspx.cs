...
public partial class AddSize : System.Web.UI.Page
{
    ...
    protected void btnAddSize_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Insert into tblSizes(SizeName,BrandID,CategoryID,SubCategoryID) Values ('" + txtSize .Text + "','" + ddlBrand .SelectedItem.Value + "','" + ddlCategory .SelectedItem.Value + "','" + ddlSubCategory .SelectedItem.Value + "','" + "')", con);
            //cmd.ExecuteNonQuery();
