...
<body>
            ...
            <div class="container ">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Default.aspx"><span>
                        <img src="icons/safeIcons.png" alt="Kingsman Eatery" height="30" /></span>Kingsman Eatery
                    </a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                      ...
                      <%--  <li id="btnAdminLogin" runat="server"><a href="AdminLogin.aspx">Admin Login</a> </li>--%>
                        <li>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                         <img src="870777.jpg" alt="Burger" style="width: 100%;height:70%;">
                    ...
                    <div class="item">
                       <img src="tornadoshd.jpg" alt="Tornados" style="width: 100%;height:70%;">
                        <div class="carousel-caption">
                            <h3>
                                Tornado</h3>
                            <p>
                   ...
                   <div class="item">
                        <img src="colddrinkshd.png" alt="Cold Drinks" style="width: 100%;height : 70%;">
                        <div class="carousel-caption">
                           <%-- <h3>
    ...
    <footer>
            <div class ="container ">
                ...
                <p>&copy;Kingsman Eatery &middot; </p>
            </div>
